...
class message_tracker extends AbstractMojo implements Hint {

  public void execute() {
    printHint("See: https://projectreactor.io/docs/core/release/reference/#context.read");
  }
}

@Mojo(name = "execution_counter")
class execution_counter extends AbstractMojo implements Hint {
...
class pagination extends AbstractMojo implements Hint {
