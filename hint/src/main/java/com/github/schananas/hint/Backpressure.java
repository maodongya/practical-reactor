...
class request_and_demand extends AbstractMojo implements Hint {
...
class limited_demand extends AbstractMojo implements Hint {
...
class uuid_generator extends AbstractMojo implements Hint {
  public void execute() {
    printHint("Read how many UUIDs have been requested and generate them in a loop.");
  }
}

@Mojo(name = "pressure_is_too_much")
class pressure_is_too_much extends AbstractMojo implements Hint {
...
class u_wont_brake_me extends AbstractMojo implements Hint {
...
class subscriber extends AbstractMojo implements Hint {
