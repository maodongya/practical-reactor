...
class sharing_is_caring extends AbstractMojo implements Hint {

  public void execute() {
    printHint("See: https://bsideup.github.io/posts/daily_reactive/split/");
  }
}

@Mojo(name = "hot_vs_cold")
class hot_vs_cold extends AbstractMojo implements Hint {
...
class history_lesson extends AbstractMojo implements Hint {
  public void execute() {
    printHint(
