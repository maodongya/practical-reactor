...
class houston_we_have_a_problem extends AbstractMojo implements Hint {
...
class potato_potato extends AbstractMojo implements Hint {
...
class under_the_rug extends AbstractMojo implements Hint {
...
class have_a_backup extends AbstractMojo implements Hint {
...
class error_reporter extends AbstractMojo implements Hint {
...
class unit_of_work extends AbstractMojo implements Hint {
...
class billion_dollar_mistake extends AbstractMojo implements Hint {
...
class resilience extends AbstractMojo implements Hint {

  public void execute() {
    printHint("https://devdojo.com/ketonemaniac/reactor-onerrorcontinue-vs-onerrorresume");
  }
}

@Mojo(name = "its_hot_in_here")
class its_hot_in_here extends AbstractMojo implements Hint {
...
@Mojo(name = "back_off")
class back_off extends AbstractMojo implements Hint {
...
class good_old_polling extends AbstractMojo implements Hint {

  public void execute() {
    printHint("See: https://bsideup.github.io/posts/daily_reactive/polling/");
  }
}
