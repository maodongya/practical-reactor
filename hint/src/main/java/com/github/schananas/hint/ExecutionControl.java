...
class slow_down_there_buckaroo extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "You need to introduce a delay between each notification. (between each onNext signal): https://projectreactor.io/docs/core/release/reference/#which.time");
  }
}

@Mojo(name = "ready_set_go")
class ready_set_go extends AbstractMojo implements Hint {
...
class non_blocking extends AbstractMojo implements Hint {

  public void execute() {
    printHint("See: https://projectreactor.io/docs/core/release/reference/#schedulers");
  }
}

@Mojo(name = "blocking")
class blocking extends AbstractMojo implements Hint {
...
class free_runners extends AbstractMojo implements Hint {
...
class sequential_free_runners extends AbstractMojo implements Hint {
...
class event_processor extends AbstractMojo implements Hint {
