...
class single_shooter extends AbstractMojo implements Hint {
...
class single_subscriber extends AbstractMojo implements Hint {
...
class it_gets_crowded extends AbstractMojo implements Hint {
...
@Mojo(name = "open_24_7")
class open_24_7 extends AbstractMojo implements Hint {
...
class blue_jeans extends AbstractMojo implements Hint {

  public void execute() {
    printHint("Which sink can replay all elements to new subscribers?");
  }
}

@Mojo(name = "emit_failure")
class emit_failure extends AbstractMojo implements Hint {
