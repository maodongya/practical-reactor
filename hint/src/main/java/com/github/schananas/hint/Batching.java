...
class batch_writer extends AbstractMojo implements Hint {
...
class command_gateway extends AbstractMojo implements Hint {
...
class sum_over_time extends AbstractMojo implements Hint {
  public void execute() {
    printHint(
