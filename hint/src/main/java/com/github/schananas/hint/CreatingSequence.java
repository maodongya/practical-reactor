...
class value_I_already_have_mono extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "Creating a New Sequence that emits a T, and you already have:  https://projectreactor.io/docs/core/release/reference/#which.create");
  }
}

@Mojo(name = "potentially_null_mono")
class potentially_null_mono extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "Creating a New Sequence from a potentially null T: https://projectreactor.io/docs/core/release/reference/#which.create");
  }
}

@Mojo(name = "optional_value")
class optional_value extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "Creating a New Sequence from an Optional<T>: https://projectreactor.io/docs/core/release/reference/#which.create");
  }
}

@Mojo(name = "callable_counter")
class callable_counter extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "Creating a New Sequence that emits from various single-valued sources such as task: https://projectreactor.io/docs/core/release/reference/#which.create");
  }
}

@Mojo(name = "future_counter")
class future_counter extends AbstractMojo implements Hint {
...
class runnable_counter extends AbstractMojo implements Hint {
...
class acknowledged extends AbstractMojo implements Hint {
...
@Mojo(name = "seen")
class seen extends AbstractMojo implements Hint {
...
class trouble_maker extends AbstractMojo implements Hint {
...
class from_array extends AbstractMojo implements Hint {
...
@Mojo(name = "from_list")
class from_list extends AbstractMojo implements Hint {
...
class from_stream extends AbstractMojo implements Hint {
...
@Mojo(name = "interval")
class interval extends AbstractMojo implements Hint {
...
@Mojo(name = "range")
class range extends AbstractMojo implements Hint {
...
@Mojo(name = "repeat")
class repeat extends AbstractMojo implements Hint {
...
class generate_programmatically extends AbstractMojo implements Hint {
...
class multi_threaded_producer extends AbstractMojo implements Hint {

  public void execute() {
    printHint(" Did you really answer all the question from previous exercise correctly?");
  }
}
