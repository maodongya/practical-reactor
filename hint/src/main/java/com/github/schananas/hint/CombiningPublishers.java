...
class behold_flatmap extends AbstractMojo implements Hint {
...
class task_executor extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "You want to transform existing data running an asynchronous task for each source item https://projectreactor.io/docs/core/release/reference/#which.values");
  }
}

@Mojo(name = "streaming_service")
class streaming_service extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "You want to transform existing data running an asynchronous task for each source item where the async task can return multiple values, from a Mono source: https://projectreactor.io/docs/core/release/reference/#which.values");
  }
}

@Mojo(name = "i_am_rubber_you_are_glue")
class i_am_rubber_you_are_glue extends AbstractMojo implements Hint {

  public void execute() {
    printHint(
        "You want to combine publishers in sequential order: https://projectreactor.io/docs/core/release/reference/#which.values");
  }
}

@Mojo(name = "task_executor_again")
class task_executor_again extends AbstractMojo implements Hint {

  public void execute() {
    printHint("Use concatMap(), obviously...");
  }
}

@Mojo(name = "need_for_speed")
class need_for_speed extends AbstractMojo implements Hint {
...
@Mojo(name = "plan_b")
class plan_b extends AbstractMojo implements Hint {
...
class mail_box_switcher extends AbstractMojo implements Hint {
...
class instant_search extends AbstractMojo implements Hint {
...
@Mojo(name = "prettify")
class prettify extends AbstractMojo implements Hint {
...
@Mojo(name = "one_to_n")
class one_to_n extends AbstractMojo implements Hint {
...
class acid_durability extends AbstractMojo implements Hint {
...
class major_merger extends AbstractMojo implements Hint {
...
class car_factory extends AbstractMojo implements Hint {
...
class deterministic extends AbstractMojo implements Hint {

  public void execute() {
    printHint("You should defer decision until subscription actually happens...");
  }
}

@Mojo(name = "cleanup")
class cleanup extends AbstractMojo implements Hint {
